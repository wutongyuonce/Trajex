...
Calm, exact, auditable. Trajex should feel trustworthy around private local history, dense without being hostile, and confident without hiding uncertainty or provenance.

## Anti-references

Trajex should not resemble an undifferentiated chat-log browser, a terminal log wall, an opaque AI-summary dashboard, or a decorative analytics product that separates conclusions from their source evidence.
